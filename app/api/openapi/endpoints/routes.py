...
SOURCE_SCHEMA_WITH_SENTRY = {
    "type": "string",
    "enum": ["alertmanager", "aws_sns", "datadog", "grafana", "rmon", "zabbix", "webhook", "sentry", "librenms", "new_relic", "uptime_kuma", "heartbeat"],
...
ROUTE_SCHEMA = {
    ...
    "properties": {
        ...
        "source": {"type": "string", "enum": ["alertmanager", "aws_sns", "datadog", "grafana", "new_relic", "rmon", "zabbix", "webhook", "sentry", "librenms", "uptime_kuma", "heartbeat"]},
