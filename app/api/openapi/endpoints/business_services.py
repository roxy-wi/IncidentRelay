...
BUSINESS_SERVICE_COMPONENT_SCHEMA = {
    ...
    "properties": {
        ...
        "own_impact_score": {"type": "integer", "nullable": True, "minimum": 0, "maximum": 100},
        "alert_impact_score": {"type": "integer", "minimum": 0, "maximum": 100},
        "dependency_impact_score": {"type": "integer", "minimum": 0, "maximum": 100},
        "effective_impact_score": {"type": "integer", "nullable": True, "minimum": 0, "maximum": 100},
        "service_impact_score": {"type": "integer", "nullable": True, "minimum": 0, "maximum": 100},
        "component_multiplier": {"type": "number", "nullable": True},
        "weighted_impact_score": {"type": "integer", "nullable": True, "minimum": 0, "maximum": 100},
        "open_alert_groups": {
            "type": "integer",
            "minimum": 0,
