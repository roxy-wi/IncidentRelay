...
def serialize_business_service_component(component, current_user=None, impact_map=None):
    ...
    data = {
        ...
        "own_impact_score": impact_item.get("own_impact_score") if impact_item else None,
        ...
        "effective_impact_score": impact_item.get("effective_impact_score") if impact_item else None,
        "service_impact_score": impact_item.get("effective_impact_score") if impact_item else None,
