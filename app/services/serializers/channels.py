from app.services.channel_config import mask_channel_config
...
def serialize_channel(channel, current_user=None):
    ...
    data = {
        ...
        "group_name": channel.group.name if getattr(channel, "group", None) else None,
        ...
        "config": mask_channel_config(channel.channel_type, channel.config),
